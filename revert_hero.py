...
target_file = r'c:\Users\uditg\OneDrive\Attachments\Desktop\PEP\Summer PEP\Summer pep capstone project\client\src\components\home\HeroNetwork.jsx'
        ...
        if d.get('type') == 'PLANNER_RESPONSE' and d.get('tool_calls'):
            for tc in d['tool_calls']:
                if tc['name'] in ['replace_file_content', 'multi_replace_file_content']:
                    args = tc.get('args', {})
                    if 'HeroNetwork.jsx' in args.get('TargetFile', ''):
...
with open(target_file, 'w', encoding='utf-8') as f:
    f.write(content)
print("Reverted HeroNetwork.jsx")
